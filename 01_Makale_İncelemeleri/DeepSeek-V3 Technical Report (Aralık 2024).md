...
- modeller eğitilirken gpu lar arası veri transferi çok yavaştır.
...
- [[Multi-Token Prediction (MTP)]] ile modeli aynı anda iki kelime  tahmin etmeye zorladılar sistem sonraki kelimeden sonraki gelecek kelimeyi tahmin edebilirse ödül bilemzesse ceza vererek bunu sağladılar ve [[FP8 Mixed Precision]] kullanarak matematiksel işlemleri 8 bit seviyesine indirip daha hızlı yapabildiler 
- modeli binlerce gpu ya böldüklerinde arada boşa düşme bekleme olmaması için [[DualPipe]] algoritması ile  veriyi hem ileri hem geri yönde aynı anda akıtarak daha stabil bir sistem sağladılar .
...
bu mantık gerçekten zamanında çok ses getirmişti ve bende projelerimde bu mantık yaklaşımını kullanacağım  temel olarak bu kullandıkları gpu ya çok optimize bir sistem kurdular başka gpularda bu kadar iyi sonuç vermeyebilirler .
şuan bundan başka nasıl bir zayıf yönü var emin değilim .
